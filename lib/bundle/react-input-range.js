...
var InputRange = (_class = function (_React$Component) {
  ...
  function InputRange(props) {
     ...
     * @type {?Component}
     */
    _this.trackNodeRef = _react2.default.createRef();
  ...
  _createClass(InputRange, [{
    ...
    value: function getTrackClientRect() {
      var trackNode = this.trackNodeRef.current;
      if (trackNode) {
    ...
    key: 'getStepPrecision',
    value: function getStepPrecision() {
    ...
    value: function hasStepDifference(values) {
      ...
      var precision = this.getStepPrecision();
      return (0, _utils.length)(values.min, currentValues.min, precision) >= this.props.step || (0, _utils.length)(values.max, currentValues.max, precision) >= this.props.step;
    }
    ...
    value: function handleTrackDrag(event, prevEvent) {
      ...
      var stepValue = valueTransformer.getStepValueFromValue(value, this.props.step, this.props.minValue, this.props.maxValue);
      ...
      var prevStepValue = valueTransformer.getStepValueFromValue(prevValue, this.props.step, this.props.minValue, this.props.maxValue);
...
var Track = (_class = function (_React$Component) {
  ...
  _createClass(Track, [{
    ...
    value: function getClientRect() {
      return this.nodeRef.current ? this.nodeRef.current.getBoundingClientRect() : {};
    }
    ...
    value: function addDocumentMouseMoveListener() {
      ...
      if (this.nodeRef.current) {
        this.nodeRef.current.ownerDocument.addEventListener('mousemove', this.handleMouseMove);
      }
    }
    ...
    value: function addDocumentMouseUpListener() {
      this.removeDocumentMouseUpListener();
      if (this.nodeRef.current) {
        this.nodeRef.current.ownerDocument.addEventListener('mouseup', this.handleMouseUp);
      }
    }
    ...
    value: function removeDocumentMouseMoveListener() {
      if (this.nodeRef.current) {
        this.nodeRef.current.ownerDocument.removeEventListener('mousemove', this.handleMouseMove);
      }
    }
    ...
    value: function removeDocumentMouseUpListener() {
      if (this.nodeRef.current) {
        this.nodeRef.current.ownerDocument.removeEventListener('mouseup', this.handleMouseUp);
      }
    }
 ...
 * @return {number}
 */
function getStepValueFromValue(value, valuePerStep, minValue, maxValue) {
  return (0, _utils.clamp)(Math.round(value / valuePerStep) * valuePerStep, minValue, maxValue);
}
